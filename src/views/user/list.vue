<template>
    <div class="center_content">
        <app-widget>
            ...
            <table  v-loading="loading" id="user" v-bind:data-url="url_list" data-cols="id,name,lastname,email,card_type,card_number,document_type,document_number" class="js-datatable">
                <thead>
                <tr>
                    <td>ID</td>
                    <td>Nombre</td>
