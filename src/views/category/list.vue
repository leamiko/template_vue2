    ...
    <div class="center_content">
        <app-widget>
            ...
            <div class="header_custom_table">
                <el-row :gutter="10">
                    <el-col :span="3">
                        <router-link :to="{ name: 'categories_new' }" >
                            <el-button type="success" >NUEVA CATEGORÍA</el-button>
                        </router-link>
                    </el-col>
                </el-row>
            </div>
            <table  v-loading="loading" id="user" v-bind:data-url="url_list" data-cols="id,name,description" class="js-datatable">
                <thead>
                <tr>
                    <td>ID</td>
                    <td>Nombre</td>
            ...
            <div class="links_table hide">
                <div class="link_search">
                    <router-link :to="{ name: 'categories_edit' }" >
                        <el-button type="primary" size="mini" title="Editar categoría">
