    ...
    (function() {
            ...
            uploadStoredFiles: function() {
                ...
                console.log(options);
                    ...
                    if (this._storedIds.length == 0) {
                        if(options.validation.allowEmpty){
                            $.ajax({
                                url : options.request.endpoint,
                                headers: options.request.customHeaders,
                                data: $("#"+options.form.element).serialize(),
                                type: 'POST',
                                dataType: "json",
                                success: function (data) {
                                    if(data.success){
                                        options.callbacks.onStatusChange('','',qq.status.UPLOAD_SUCCESSFUL);
                                    }else{
                                        options.callbacks.onStatusChange('','',qq.status.UPLOAD_FAILED);
                                    }
                                }
                            });
                        }else{
        ...
        qq.basePrivateApi = {
            ...
            _onValidateBatchCallbackSuccess: function(validationDescriptors, items, params, endpoint, button) {
                ...
                if (itemLimit === 0 || proposedNetFilesUploadedOrQueued <= itemLimit) {
                    if (items.length > 0) {
                        ...
                        console.log ('_onValidateBatchCallbackSuccess');
                        this._itemError("noFilesError");
                    }
                } else {
            ...
            _prepareItemsForUpload: function(items, params, endpoint) {
                if (items.length === 0) {
                    console.log ('_prepareItemsForUpload');
                    this._itemError("noFilesError");
                    return;
                }
            ...
            _uploadStoredFiles: function() {
                ...
                console.log('recorriendo id para enviar');
